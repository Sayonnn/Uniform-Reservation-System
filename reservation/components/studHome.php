    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <button class = "btn btn-danger btn-sm m-1 position-absolute end-0 t-0" data-bs-toggle='modal' data-bs-target='#receiptInfo'><i class="fa-solid fa-receipt mx-2"></i>Print Receipt</button>
            </ul>
        </div>
            ...
            <table id="itemList">
                ...
                <tbody>
                    ...
                    if ($numReservations > 0) {
                        ...
                        $sql2 = 'select * from tbreservedetails as reserve join tbstatus on reserve.reservationid = tbstatus.reservationid';
                        ...
                        while ($row = mysqli_fetch_assoc($display)) {
                            ...
                            if($row2 = mysqli_fetch_assoc($query2)){
                                $id = $row2['reservationid'] ;
                                $newstatus = $row2['resStatus'];
                                $notes = $row2['statusNote'];
                            }else{
                                $id ="";
                                $newstatus = '';
                                $notes = 'No Reminder from RGO';
                            }
                            ...
                            echo "<td>
                                    ...
                                    <th>
                                        ...
                                        <form method = 'post'>
                                            <button type='button' class='btn btn-$color btn-lg' data-bs-toggle='modal' data-bs-target='#statusInfo' name = 'btnStatus' onClick = \"changeNote('{$id}','{$newstatus}','{$notes}')\">  </button>
                                        </form>
                                        </div>  
                                    </th>
                            </td>
