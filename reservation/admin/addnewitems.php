...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO tbproductinfo (itemname, sizes, stocks, price, item_img) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("ssids", $item, $size, $quantity, $price, $imageData);
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <input type="number" name="stocks" min="1" required><br>
