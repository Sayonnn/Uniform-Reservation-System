...
<body>
    ...
    if (isset($_POST['btnsearch'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div class='' style='overflow-y: auto;'>";
            ...
            while ($innerRow = $innerResult->fetch_assoc()) {
                ...
                echo "<button type='button' name='canceled' class='btn {$declineStyle} mx-2' style = 'border-radius:15px;' onClick = \"sendEmail('{$id}','{$newstatus}','{$name}','{$price}')\"><i class='fa-solid fa-trash mx-2'></i></button>";
